    ...
    <header className="sticky top-0 z-50 bg-white shadow-sm">
      ...
      <div className="container mx-auto flex h-20 items-center justify-between px-4">
        ...
        <nav className="hidden items-center gap-8 md:flex">
          <Link href="/menu" className="flex items-center gap-2 text-sm font-medium text-gray-700 hover:text-cw-red">
          ...
          <Link href="/locales" className="flex items-center gap-2 text-sm font-medium text-gray-700 hover:text-cw-red">
        ...
        <div className="flex items-center gap-6">
          ...
          >
            ...
            <div className="flex flex-col leading-tight text-sm">
              ...
              <span className="font-bold text-cw-green">INICIAR SESIÓN</span>
            </div>
          </Link>
      ...
      <div className="border-t border-gray-100">
        <div className="container mx-auto flex items-center justify-between px-4 py-2">
          <div className="flex items-center gap-4">
            <Button className="bg-cw-green hover:bg-green-700 text-white rounded-full h-8 text-xs px-4 font-normal">
          ...
          <div className="hidden md:flex items-center gap-4 text-xs text-gray-500">
            ...
            <Link href="/tracking/order/index" className="flex items-center gap-1 hover:text-cw-red">
